...
//---------------------------------------------------------------------------
int __fastcall MKnowledgeBase::GetResStrIdx(int from, wchar_t* ResStrContext){
	return GetResStrIdx(from, AnsiString(ResStrContext).c_str());
}
...
//---------------------------------------------------------------------------
int __fastcall MKnowledgeBase::GetResStrIdx(WORD* ModuleIDs, wchar_t* ResStrName)
{
	 return MKnowledgeBase::GetResStrIdx(ModuleIDs, String(ResStrName).c_str());
}
...
{
	assert(Offset >= 0 && (int)Offset < SizeKBFile && ((int)Offset + (int)Size < SizeKBFile));
